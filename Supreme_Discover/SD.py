...
class IMDBSentimentAnalyzer:
    ...
    def build_model(self):
        print("Building BiLSTM model with attention...")
        model = Sequential()
...
def main():
    ...
    if metrics['accuracy'] >= 0.92:
        ...
        print("Accuracy below target. Consider adjusting parameters.")
